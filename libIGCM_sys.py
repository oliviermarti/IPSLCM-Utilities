...
def Mach (long:bool=False) -> str :
    ...
    if SysName == 'Darwin' and ( 'lsce5138' in NodeName or 'sargas028' in NodeName ) :
        zmach = 'Spip'
...
DEFAULT_OPTIONS = Container (
            ...
            IGCM_Catalog_list    = IGCM_Catalog_list,
            )
...
class Config :
    ...
    def __init__ (self, JobName=None, TagName=None, SpaceName=None, ExperimentName=None,
                  ...
                  OCE=None, ATM=None, OCE_DOM=None, ATM_DOM=None,
        ...
        if DateBegin and not DateBeginGregorian :
            DateBeginGregorian = libIGCM_date.ConvertFormatToGregorian (DateBegin)
        if DateEnd   and not DateEndGregorian   :
            DateEndGregorian   = libIGCM_date.ConvertFormatToGregorian (DateEnd  )
