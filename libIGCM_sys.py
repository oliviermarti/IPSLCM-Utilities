...
def config ( JobName=None , TagName=None  , SpaceName=None, ExperimentName=None,
             ...
             Out='dict') :
    '''
    Defines the libIGCM directories - Returns a dictionary or a namespace
    ...
    #    if Source == 'TGCC_thredds' : IGCM_OUT_name = ''
    ...
    if Source == 'IDRIS_thredds' :
        ...
        if not R_IN    : R_IN    = f'{ThreddsPrefix}/work/igcmg/IGCM'
        if not R_GRAF  : R_GRAF  = \
            'https://thredds-su.ipsl.fr/thredds/dodsC/tgcc_thredds/work/p86mart/GRAF/DATA'
    ...
    if Host == 'Spip' :
        ...
        if not TmpDir     : TmpDir      = os.path.join ( '/', 'Users', LocalUser, 'Scratch' )
    ...
    libIGCM = { 'TagName'       : TagName,
                ...
                'User'          : User,
                'Group'         : Group,
                'IGCM_OUT_name' : IGCM_OUT_name,
                'rebuild'       : rebuild,
                'TmpDir'        : TmpDir,
                'TGCC_User'     : TGCC_User,
                'TGCC_Group'    : TGCC_Group,
                'Thredds'       : ThreddsPrefix,
                'IDRIS_User'    : IDRIS_User,
                'IDRIS_Group'   : IDRIS_Group }
