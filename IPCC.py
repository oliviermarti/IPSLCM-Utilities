...
cmap.qualitative_2   = create_colormap (cmap.colors_qualitative[0: 6], reverse=False, name='qualitative_2'  )
cmap.qualitative_2_r = create_colormap (cmap.colors_qualitative[0: 6], reverse=False, name='qualitative_2_r'  )

cmap.qualitative_3   = create_colormap (cmap.colors_qualitative[0: 9], reverse=False, name='qualitative_3'  )
cmap.qualitative_3_r = create_colormap (cmap.colors_qualitative[0: 9], reverse=False, name='qualitative_3_r'  )

cmap.qualitative_4   = create_colormap (cmap.colors_qualitative[0:12], reverse=False, name='qualitative_4'  )
cmap.qualitative_4_r = create_colormap (cmap.colors_qualitative[0:12], reverse=False, name='qualitative_4_r'  )

cmap.qualitative_5   = create_colormap (cmap.colors_qualitative[0:15], reverse=False, name='qualitative_5'  )
cmap.qualitative_5_r = create_colormap (cmap.colors_qualitative[0:15], reverse=False, name='qualitative_5_r'  )

cmap.qualitative_6   = create_colormap (cmap.colors_qualitative[0:18], reverse=False, name='qualitative_6'  )
cmap.qualitative_6_r = create_colormap (cmap.colors_qualitative[0:18], reverse=False, name='qualitative_6_r'  )

cmap.qualitative     = create_colormap (cmap.colors_qualitative[0:18], reverse=False, name='qualitative'  )
cmap.qualitative_r   = create_colormap (cmap.colors_qualitative[0:18], reverse=False, name='qualitative_r' )
...
# Precip 7 colors
cmap.colors_precip_7 = [140, 81, 10, 216, 179, 101, 246, 232, 195, 245, 245, 245, 199, 234, 229, 90, 180, 172, 1, 102, 94]
...
# Precip 8 colors
cmap.colors_precip_8 = [140, 81, 10, 191, 129, 45, 223, 194, 125, 246, 232, 195, 199, 234, 229, 128, 205, 193, 53, 151, 143, 1, 102, 94]
...
# Precip 9 colors
cmap.colors_precip_9 = [140, 81, 10, 191, 129, 45, 223, 194, 125, 246, 232, 195, 245, 245, 245, 199, 234, 229, 128, 205, 193, 53, 151, 143, 1, 102, 94]
...
# Precip 10 colors
cmap.colors_precip_10 = [84, 48, 5, 140, 81, 10, 191, 129, 45, 223, 194, 125, 246, 232, 195, 199, 234, 229, 128, 205, 193, 53, 151, 143, 1, 102, 94, 0, 60, 48]
...
# Precip 11 colors
cmap.colors_precip_11=[84, 48, 5, 140, 81, 10, 191, 129, 45, 223, 194, 125, 246, 232, 195, 245, 245, 245, 199, 234, 229, 128, 205, 193, 53, 151, 143, 1, 102, 94, 0, 60, 48]
...
# Temp 5 cmap.colors
cmap.colors_temp_5 = [202, 0, 32, 244, 165, 130, 247, 247, 247, 146, 197, 222, 5, 113, 176]
...
# Temp 6 colors
cmap.colors_temp_6 =[178, 24, 43, 239, 138, 98, 253, 219, 199, 209, 229, 240, 103, 169, 207, 33, 102, 172]
...
# Temp 7 colors
cmap.colors_temp_7 =[178, 24, 43, 239, 138, 98, 253, 219, 199, 247, 247, 247, 209, 229, 240, 103, 169, 207, 33, 102, 172]
...
# Temp 8 colors
cmap.colors_temp_8 =[178, 24, 43, 214, 96, 77, 244, 165, 130, 253, 219, 199, 209, 229, 240, 146, 197, 222, 67, 147, 195, 33, 102, 172]
...
# Temp 9 colors
cmap.colors_temp_9 =[178, 24, 43, 214, 96, 77, 244, 165, 130, 253, 219, 199, 247, 247, 247, 209, 229, 240, 146, 197, 222, 67, 147, 195, 33, 102, 172]
...
# Temp 10 colors
cmap.colors_temp_10 =[103, 0, 31, 178, 24, 43, 214, 96, 77, 244, 165, 130, 253, 219, 199, 209, 229, 240, 146, 197, 222, 67, 147, 195, 33, 102, 172, 5, 48, 97]
...
# Temp 11 colors
cmap.colors_temp_11 = [103, 0, 31, 178, 24, 43, 214, 96, 77, 244, 165, 130, 253, 219, 199, 247, 247, 247, 209, 229, 240, 146, 197, 222, 67, 147, 195, 33, 102, 172, 5, 48, 97]
...
# Temp continous
cmap.temp   = create_colormap (cmap.colors_temp_11, reverse=False, name='temp'  , continuous=True)
cmap.temp_r = create_colormap (cmap.colors_temp_11, reverse=True , name='temp_r', continuous=True)
...
cmap.colors_MultiCat_3.extend ( cmap.colors_Purple_5[6:])
cmap.colors_MultiCat_3.extend ( cmap.colors_Blue_5  [6:]  )
cmap.colors_MultiCat_3.extend ( cmap.colors_Green_5 [6:] )
cmap.colors_MultiCat_3.extend ( cmap.colors_Red_5   [6:]   )
...
cmap.colors_MultiCat_4.extend ( cmap.colors_Purple_5[3:])
cmap.colors_MultiCat_4.extend ( cmap.colors_Blue_5  [3:]  )
cmap.colors_MultiCat_4.extend ( cmap.colors_Green_5 [3:] )
cmap.colors_MultiCat_4.extend ( cmap.colors_Red_5   [3:]   )
