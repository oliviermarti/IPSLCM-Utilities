...
Color.ShadingHexa = [ map ( lambda x: color2hex (*x), Color.Shading ) ]
...
RCP.ColorLineHexa = dict (zip (RCP.ColorLine.keys(),
         list (map(lambda x: color2hex (*x), RCP.ColorLine.values()))))
...
def create_colormap (colors, position=None, bit=True, reverse=False,
    ...
    if position is not None and not isinstance (position, np.ndarray):
        ...
        if not np.isclose(position[0], 0) and not np.isclose(position[-1], 1):
...
# Qualitative
cmap.colors_qualitative = [[0, 0, 0], [112, 160, 205], [196, 121, 0], [178, 178, 178],
                           [0, 52, 102], [0, 79, 0]]
cmap.qualitative_2   = create_colormap (cmap.colors_qualitative[0:2], reverse=False,
                                        name='qualitative_2'  )
cmap.qualitative_2_r = create_colormap (cmap.colors_qualitative[0:2], reverse=True ,
                                        name='qualitative_2_r')

cmap.qualitative_3   = create_colormap (cmap.colors_qualitative[0:3], reverse=False,
                                        name='qualitative_3'  )
cmap.qualitative_3_r = create_colormap (cmap.colors_qualitative[0:3], reverse=True ,
                                        name='qualitative_3_r')

cmap.qualitative_4   = create_colormap (cmap.colors_qualitative[0:4], reverse=False,
                                        name='qualitative_4'  )
cmap.qualitative_4_r = create_colormap (cmap.colors_qualitative[0:4], reverse=True ,
                                        name='qualitative_4_r')

cmap.qualitative_5   = create_colormap (cmap.colors_qualitative[0:5], reverse=False,
                                        name='qualitative_5'  )
cmap.qualitative_5_r = create_colormap (cmap.colors_qualitative[0:5], reverse=True ,
                                        name='qualitative_5_r')

cmap.qualitative_6   = create_colormap (cmap.colors_qualitative[0:6], reverse=False,
                                        name='qualitative_6'  )
cmap.qualitative_6_r = create_colormap (cmap.colors_qualitative[0:6], reverse=True ,
                                        name='qualitative_6_r')

cmap.qualitative     = create_colormap (cmap.colors_qualitative, reverse=False,
                                        name='qualitative'  )
cmap.qualitative_r   = create_colormap (cmap.colors_qualitative, reverse=True ,
                                        name='qualitative_r')

# Precip 5 cmap.colors
cmap.colors_precip_5 = [[166, 97, 26], [223, 194, 125], [245, 245, 245],
...
# Precip 6 colors
cmap.colors_precip_6 = [[140, 81, 10], [216, 179, 101] ,[246, 232, 195], [199, 234, 229],
                        [90, 180, 172], [1, 102, 94]]
...
# Precip 10 colors
cmap.colors_precip_10 = [[ 84,  48,   5], [140,  81,  10], [191, 129,  45], [223, 194, 125],
                         [246, 232, 195], [199, 234, 229], [128, 205, 193],  [53, 151, 143],
                         [1, 102, 94], [0, 60, 48]]
...
# Precip 11 colors
cmap.colors_precip_11 = [[ 84,  48,   5], [140,  81,  10], [191, 129,  45], [223, 194, 125],
...
# Precip continous
cmap.precip   = create_colormap (cmap.colors_precip_11, reverse=False,
                                 name='precip'  , continuous=True)
cmap.precip_r = create_colormap (cmap.colors_precip_11, reverse=True ,
                                 name='precip_r', continuous=True)

# Temp 5 cmap.colors
cmap.colors_temp_5 = [[ 5, 113, 176], [146, 197, 222], [247, 247, 247], [244, 165, 130],
                      [202, 0,  32]]
...
# Temp 9 colors
cmap.colors_temp_9 = [[ 33, 102, 172], [67, 147, 195], [146, 197, 222], [209, 229, 240],
...
# Temp 10 colors
cmap.colors_temp_10 = [[5,  48,  97], [33, 102, 172], [67, 147, 195], [146, 197, 222],
...
# Temp 11 colors
cmap.colors_temp_11 = [[  5,  48,  97], [ 33, 102, 172], [ 67, 147, 195], [146, 197, 222],
...
cmap.colors_Blue_5 = [[239, 243, 255], [189, 215, 231], [107, 174, 214],
                      [49, 130, 189], [8, 81, 156]]
...
cmap.colors_Purple_5 = [[242, 240, 247], [203, 201, 226], [158, 154, 200],
...
cmap.colors_Red_5 = [[254, 229, 217], [252, 174, 145], [251, 106, 74],
                     [222, 45, 38], [165, 15, 21]]
...
cmap.colors_Green_5 = [[237, 248, 233], [186, 228, 179], [116, 196, 118],
                       [49, 163, 84], [0, 109, 44]]
...
cmap.colors_YlBl_5 = [[255, 255, 204], [161, 218, 180], [65, 182, 196],
...
cmap.colors_BlPr_5 = [[237, 248, 251], [179, 205, 227], [140, 150, 198],
...
cmap.colors_YlRd_5 = [[255, 255, 178], [254, 204, 92], [253, 141, 60],
                      [240, 59, 32], [189, 0, 38]]
...
cmap.colors = [[255, 255, 204], [194, 230, 153], [120, 198, 121], [49, 163, 84],
               [0, 104, 55]]
...
def multicat (ncolors:int=19, trunk:str='high', reverse:bool=False, name:str='MultiCat',
    ...
    match trunk :
        case 'low'  :
            MultiCat = MultiCat [nd:]
        case 'high' :
            MultiCat = MultiCat [:ncolors]
        case 'both' :
            MultiCat = MultiCat [nd//2:ncolors+nd//2]
