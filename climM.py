...
def yseamean (dd: xr.Dataset, varname:str, season:str='JJAS', drop_incomplete_djf:bool=True,
              dec_mode:str='DJF') -> xr.DataArray :
    '''
    ...
    if season == 'JJAS' :
        ...
        if xc.__version__ >= '0.8' :
            ...
            nseason = 1
            custom_seasons = [ ["Jan", "Feb", "Mar", "Apr", "May"],
                              ["Jun", "Jul", "Aug", "Sep"],
                              ["Oct", "Nov", "Dec"] ]
    if season == 'MAMJ' :
        use_custom=True
        if xc.__version__ >= '0.8' :
            ...
            custom_seasons = [ ["Jan", "Feb"], ["Mar", "Apr", "May", "Jun"],
